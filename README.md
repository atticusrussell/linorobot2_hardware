...
:----------: | :----: | :----------:
**Rolling** | [`master`](https://github.com/atticusrussell/linorobot2_hardware/tree/master) | [![Rolling Firmware Build](../../actions/workflows/rolling-firmware-build.yml/badge.svg?branch=HEAD)](../../actions/workflows/rolling-firmware-build.yml?branch=HEAD)
